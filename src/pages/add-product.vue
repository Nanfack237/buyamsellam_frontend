            ...
            <v-row justify="space-between" class="d-flex justify-center px-5 pt-4 pb-2">
              <v-col cols="auto" class="">
                <p class="font-weight-bold text-h6" style="color:#0D47A1;">
                  Add a product <v-icon>mdi-package</v-icon>
                </p>
              </v-col>
              <v-col cols="auto">
            ...
            <form @submit.prevent="AddProduct()">
              <v-container>
                <p class="text-medium-emphasis py-2">
                  Please enter the details to save a product
                </p>
                <v-row>
                  <v-col cols="12" sm="6" md="4" class="">
                    <v-card flat border="grey-lighten-4 thin opacity-60" class="border-thin" height="310">
  ...
  const AddProduct = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setTimeout(() => router.push('/add-product'), 4000);
